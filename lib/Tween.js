...
(function() {
	...
	this.to = function(n, t) {
		...
		for (var t in o) {
			...
			void 0 !== r[t] && (i[t] = r[t], i[t] instanceof Array == !1 && (i[t] *= 1), u[t] = i[t] || 0)
		}
		return this
	}, this.stop = function() {
		return c ? (TWEEN.remove(this), c = !1, null !== T && T.call(r, r), this.stopChainedTweens(), this) : this
	}, this.end = function() {
		...
		var c, T, N;
		if (n < l) return !0;
		w === !1 && (null !== v && v.call(r, r), w = !0), T = (n - l) / e, T = T > 1 ? 1 : T, N = E(T);
		for (c in o) if (void 0 !== i[c]) {
			var W = i[c] || 0,
				O = o[c];
